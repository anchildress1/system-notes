...
test.describe('AI Readiness & SEO', () => {
    ...
    test('should allow AI bots to access the homepage', async ({ page }) => {
        ...
        await expect(page.getByRole('heading', { name: "Ashley Childress' System Notes" })).toBeVisible();
        await expect(page.getByText("Ashley Childress's engineering portfolio")).toBeVisible();
    });
