...
- The gate itself is dropped to 89 (2026-09-24) because GitHub Actions' runner measured `/projects` below the 92 floor: 0.91, 0.91, 0.90, 0.90, 0.91 across 5 runs, median 0.91. This is a CI-hardware gap, not a code regression — the underlying LCP/JS-weight cause above is unchanged. Restore to 92 once the CI runner variance is characterized and the floor is re-measured against it directly, not just against local runs.
