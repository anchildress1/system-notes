...
## [1.0.0](https://github.com/anchildress1/system-notes/compare/api-v2.0.0...api-v1.0.0) (2026-02-06)
...
* **algolia:** add dark/light compatible diagrams, ignore .verdent cache ([02f4098](https://github.com/anchildress1/system-notes/commit/02f4098c1ef0bb0507ea7837f0bbf9a42ae83b38))
* **algolia:** update AGENTS.md with knowledge graph context ([91e1100](https://github.com/anchildress1/system-notes/commit/91e1100916e385ac4958edcd0ebb51dd0b897a3f))
* **api:** refine system prompt tone and identity ([104174c](https://github.com/anchildress1/system-notes/commit/104174ccf2aaec87fdebf8ffe62962883b65ed4a))
* update algolia docs, prompt, and project data ([171f6ca](https://github.com/anchildress1/system-notes/commit/171f6ca0d5f7f1d2d066c6829d44848c45ec4dfb))
...
## [1.2.0](https://github.com/anchildress1/system-notes/compare/api-v1.1.0...api-v1.2.0) (2026-01-28)

> _The backend: now distributed across multiple regions to better confuse the request logs._

This release teaches the API to handle the music player, but mostly it involves crushing the CORS errors that have been haunting the logs. We also secured the backend — code for 'we stopped letting the internet guess our endpoints'.
