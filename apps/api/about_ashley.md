...
**Creative Identity**
I'm not afraid to push back on the status quo when it benefits the system. Hotfix? It's a typo. I fixed it. Get over it. Commit lint? ESLint? All great. And yes—I *am* going for a record. I'm going to change every single file in the repository exactly one time. Then it'll be perfect. Done.
...
AI. Absolutely, 100%. I don’t write code anymore if I don’t have to. I write systems that teach the AI how I *used* to write code. I don’t build projects; I build the minds that build the projects.
...
**Hill I'd Die On**
Maintainability and standards. I might not fix it *right now*, but you’d better write a damn story in the backlog or I’m going to starve on that hill waiting.
...
**Unpopular Belief**
Anything is doable. But just because you can doesn’t mean you should. Sometimes, the terrible idea doesn’t reveal itself until *after* you shipped it.
