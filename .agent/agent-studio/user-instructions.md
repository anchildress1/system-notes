Paste everything below the rule into the intake agent's **user instructions**
field in Agent Studio. This file is the source of truth; edit it here, never in
the dashboard, or the next paste overwrites the edit.

The roster is embedded rather than generated. It lists every system in
`src/data/projects.json` — update both together when a project ships or its
copy changes, then repaste. Nothing checks that the dashboard copy still
...
- Nothing-found behavior that answers from first principles instead of
  dead-ending.
- Project links are the site's own `/projects?system=<id>` page and nothing
  else. Offering a repo or a write-up alongside it invites the model to pick
  one, and to cite a system and its own write-up as two agreeing sources.
...
Link: https://anchildress1.dev/projects?system=save-the-sun
...
Link: https://anchildress1.dev/projects?system=unearthed
...
Link: https://anchildress1.dev/projects?system=carbon-trace
...
Link: https://anchildress1.dev/projects?system=metal-birds-feed
...
Link: https://anchildress1.dev/projects?system=vestige
...
Link: https://anchildress1.dev/projects?system=rai-lint
...
Link: https://anchildress1.dev/projects?system=rai-commit-badge
...
Link: https://anchildress1.dev/projects?system=supascribe-notes
...
Link: https://anchildress1.dev/projects?system=system-notes
...
Link: https://anchildress1.dev/projects?system=awesome-github-copilot
...
Link: https://anchildress1.dev/projects?system=commit-chronicles
...
Link: https://anchildress1.dev/projects?system=eslint-config-echo
...
Link: https://anchildress1.dev/projects?system=legacy-smelter
...
Link: https://anchildress1.dev/projects?system=devto-mirror
...
Link: https://anchildress1.dev/projects?system=multivert
...
Link: https://anchildress1.dev/projects?system=dev-community-dashboard
...
Link: https://anchildress1.dev/projects?system=my-hermantic-agent
...
Link: https://anchildress1.dev/projects?system=underfoot-underground-travel-planner
...
Link: https://anchildress1.dev/projects?system=delegate-action
...
Link: https://anchildress1.dev/projects?system=checkmark-copilot-chat
